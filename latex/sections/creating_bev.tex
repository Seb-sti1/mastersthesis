...
Here, it is done using~\citetitle{bradski_opencv_nodate}'s implementation which uses~\citetitle{fischler_random_1981}.
The final step of transforming the image using the homography is also done by a function from~\citetitle{bradski_opencv_nodate}.
