...
% DTU logo
    \begin{tikzpicture}[remember picture,overlay]
        ...
        at (current page.north west)
            {\includegraphics[width=14.75mm,keepaspectratio]{logo/dtu/\dtulogocolour_\targetcolourmodel.pdf}};
    \end{tikzpicture}
...
% Cover photo
    \begin{tikzpicture}[remember picture,overlay]
        ...
        {\includegraphics[height=15.9cm,keepaspectratio]{illustrations/mt_frontimage}};
    \end{tikzpicture}
\end{titlepage}
