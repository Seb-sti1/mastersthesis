...
| `docker run -it --name mastersthesis --gpus all  -v /home/seb-sti1/sebspace/mastersthesis:/app/mastersthesis sebsti1/mt_python:latest` | Run the image to run the scripts |
